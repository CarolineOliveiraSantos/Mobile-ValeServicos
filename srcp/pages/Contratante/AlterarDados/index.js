...
const AlterarDadoss = () => {
    ...
    async function handleAlterar() {
        try {
            ...
            const response = await api.put(`editarcontratantes/${contratanteId}`, data);
    ...
    return (
        <View style={styles.container}>
            <ScrollView showsVerticalScrollIndicator={false} horizontal={false}>
                ...
                <Text style={styles.textText}>Nome:</Text><TextInput style={styles.input} onChangeText={setNome} autoCorrect={false} placeholder={contratante.nome} placeholderTextColor="#000" />
                <Text style={styles.textText}>Email:</Text><TextInput style={styles.input} onChangeText={setEmail} placeholder={contratante.email} placeholderTextColor="#000" />
                <Text style={styles.textText}>CPF:</Text><TextInput style={styles.input} keyboardType="number-pad" onChangeText={setCpf} placeholder={contratante.cpf} placeholderTextColor="#000" />
                ...
                <Text style={styles.textText}>Telefone:</Text><TextInput style={styles.input} keyboardType="number-pad" onChangeText={setTelefone} placeholder={contratante.telefone} placeholderTextColor="#000" />
                <Text style={styles.textText}>Cidade:</Text><TextInput style={styles.input} onChangeText={setCity} autoCorrect={false} placeholder={contratante.city} placeholderTextColor="#000" />
                </View>
                 ))}
