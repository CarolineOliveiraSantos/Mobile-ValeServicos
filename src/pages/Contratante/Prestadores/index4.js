...
const Prestadoress4 = () => {
  ...
  function handleNavigateToDetalhes4(prestador) {
    navigation.navigate("Detalhes4", {prestador});
  }
          ...
          <View keyExtractor={(prestador) => String(prestador.id)}>
            <View style={styles.descriptionContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={() => handleNavigateToDetalhes4(prestador)}>
