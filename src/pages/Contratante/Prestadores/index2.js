...
const Prestadoress2 = () => {
  ...
  function handleNavigateToDetalhes2(prestador) {
    navigation.navigate("Detalhes2", {prestador});
  }
    ...
    <ScrollView showsVerticalScrollIndicator={false} horizontal={false}>
      <View style={styles.container}>
        ...
        <Text style={[styles.title, { marginStart: 25, marginEnd: 25 }]}>
          Prestadores de Serviços de Jardinagem
        </Text>
          ...
          <View keyExtractor={(prestador) => String(prestador.id)}>
            <View style={styles.descriptionContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={() => handleNavigateToDetalhes2(prestador)}>
