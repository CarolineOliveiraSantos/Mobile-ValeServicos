...
const Prestadoress3 = () => {
  ...
  function handleNavigateToDetalhes3(prestador) {
    navigation.navigate("Detalhes3", {prestador});
  }
    ...
    <ScrollView showsVerticalScrollIndicator={false} horizontal={false}>
      <View style={styles.container}>
        ...
        <Text style={[styles.title, { marginStart: 25, marginEnd: 25 }]}>
          Prestadores de Serviços Domésticos Técnicos
        </Text>
          ...
          <View keyExtractor={(prestador) => String(prestador.id)}>
            <View style={styles.descriptionContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={() => handleNavigateToDetalhes3(prestador)}>
