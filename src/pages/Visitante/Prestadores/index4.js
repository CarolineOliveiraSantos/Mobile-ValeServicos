...
const Prestadores4 = () => {
    ...
    function handleNavigateToDetalhes4() {
        navigation.navigate('Detalhes4')
    }
    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false} horizontal={false}>
            <View style={styles.container}>
                ...
                <Text style={[styles.title, {marginStart:25, marginEnd: 25 }]}>Cuidadores e Babás</Text>
                
                <View style={styles.descriptionContainer}>
                <Text style={[styles.description, {marginTop: 10}]}>Nome:</Text>
                <Text style={[styles.dataValue]}>Fausto Augusto Prada</Text>
                <Text style={[styles.description]}>Tipo de Trabalho:</Text>
                <Text style={styles.dataValue}>Cuido de pessoas e animais</Text>
                <Text style={[styles.description]}>Telefone:</Text>
                <Text style={styles.dataValue}>99999-8888</Text>
                <View style={styles.linklink}>
                <View style={styles.linkSection}>
                <Text style={[{fontWeight: 'bold', fontSize: 18, paddingHorizontal: 10, color:'#0426B0'}]} onPress={handleNavigateToDetalhes4}>Ver Mais</Text>
                </View>
                <Text>
                    <Text onPress={handleNavigateToDetalhes4}>
