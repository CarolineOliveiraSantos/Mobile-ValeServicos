...
const Prestadores3 = () => {
    ...
    function handleNavigateToDetalhes3() {
        navigation.navigate('Detalhes3')
    }
    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false} horizontal={false}>
            <View style={styles.container}>
                ...
                <Text style={[styles.title, {marginStart:25, marginEnd: 25 }]}>Prestadores de Serviços Técnicos</Text>
                
                <View style={styles.descriptionContainer}>
                <Text style={[styles.description, {marginTop: 10}]}>Nome:</Text>
                <Text style={[styles.dataValue]}>Luis Vitão Armani</Text>
                <Text style={[styles.description]}>Tipo de Trabalho:</Text>
                <Text style={styles.dataValue}>Faço gato</Text>
                <Text style={[styles.description]}>Telefone:</Text>
                <Text style={styles.dataValue}>99999-8888</Text>
                <View style={styles.linklink}>
                <View style={styles.linkSection}>
                <Text style={[{fontWeight: 'bold', fontSize: 18, paddingHorizontal: 10, color:'#0426B0'}]} onPress={handleNavigateToDetalhes3}>Ver Mais</Text>
                </View>
                <Text>
                    <Text onPress={handleNavigateToDetalhes3}>
